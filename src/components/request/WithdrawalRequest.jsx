...
const WithdrawalRequest = () => {
  ...
  return (
    <div className="flex justify-center md:items-center md:bg-red-300">
      <motion.div
        className="w-[390px] bg-white flex mt-16 flex-col items-center rounded-[32px] rounded-t-[32px] "
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 0.5 }}
      >
        <motion.div
          className="w-[390px] h-16 flex items-center px-4 absolute mt-16 rounded-t-[32px] top-0 bg-white z-10"
